---
title: "如何选择合适的 AI 模型？"
description: "ArmNet 字元服务 大模型API中转平台上不同场景下的AI模型选择建议"
lastUpdated: true
---
...
## 基本原则[​](/faq/model-selection-guide#基本原则 "基本原则的直接链接")

1. **优先选新模型：** 通常新一代模型（如 GPT-4o, Claude 3.5）在性能、成本和速度上都有优化。
2. **按场景选型：** 没有绝对最好的模型，只有最适合的模型。

## 场景推荐[​](/faq/model-selection-guide#场景推荐 "场景推荐的直接链接")

### 1. 通用对话与内容创作[​](/faq/model-selection-guide#1-通用对话与内容创作 "1. 通用对话与内容创作的直接链接")
...
### 2. 复杂推理与数据分析[​](/faq/model-selection-guide#2-复杂推理与数据分析 "2. 复杂推理与数据分析的直接链接")
...
### 3. 代码生成与技术开发[​](/faq/model-selection-guide#3-代码生成与技术开发 "3. 代码生成与技术开发的直接链接")
...
### 4. 批量处理与高并发[​](/faq/model-selection-guide#4-批量处理与高并发 "4. 批量处理与高并发的直接链接")
...
### 5. 图像生成[​](/faq/model-selection-guide#5-图像生成 "5. 图像生成的直接链接")
