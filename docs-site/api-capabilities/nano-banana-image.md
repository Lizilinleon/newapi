...
description: "通过 ArmNet 字元服务 大模型API中转服务调用 Nano Banana Pro 生成 4K 高清图像"
lastUpdated: true
---
...
## 核心特性[​](/api-capabilities/nano-banana-image#核心特性 "核心特性的直接链接")
...
## 价格优势[​](/api-capabilities/nano-banana-image#价格优势 "价格优势的直接链接")

相比 Google 官方定价，使用 ArmNet 字元服务 可节省大量成本。

## 代码示例[​](/api-capabilities/nano-banana-image#代码示例 "代码示例的直接链接")

### OpenAI 兼容模式 (Python)[​](/api-capabilities/nano-banana-image#openai-兼容模式-python "OpenAI 兼容模式 (Python)的直接链接")
