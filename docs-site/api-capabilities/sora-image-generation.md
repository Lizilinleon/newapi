...
description: "通过 ArmNet 字元服务 大模型API中转服务调用 Sora Image 文本生图，简单高效"
lastUpdated: true
---
...
## 核心特性[​](/api-capabilities/sora-image-generation#核心特性 "核心特性的直接链接")

- **模型支持**：`sora_image`, `gpt-4o-image`.
- **宽高比**：支持 2:3, 3:2, 1:1。
- **调用方式**：标准的 Chat Completion API。

## 使用方法[​](/api-capabilities/sora-image-generation#使用方法 "使用方法的直接链接")

通过在 Prompt 中添加标签来指定宽高比，例如 `【2:3】`。

### Python 示例[​](/api-capabilities/sora-image-generation#python-示例 "Python 示例的直接链接")
...
## 注意事项[​](/api-capabilities/sora-image-generation#注意事项 "注意事项的直接链接")
