...
description: "ArmNet 字元服务 大模型API中转服务对 OpenAI Responses API 的完整支持说明"
lastUpdated: true
---

# OpenAI Responses API 支持

Responses API 是 OpenAI 最新推出的智能体 (Agent) 构建接口，旨在简化构建具备多步推理、工具使用和状态管理能力的 AI 应用。ArmNet 字元服务 已全量支持该接口。

## 核心特性[​](/api-capabilities/openai-responses#核心特性 "核心特性的直接链接")
...
## 快速开始[​](/api-capabilities/openai-responses#快速开始 "快速开始的直接链接")

### Python 示例[​](/api-capabilities/openai-responses#python-示例 "Python 示例的直接链接")
...
## 与 Chat Completions API 对比[​](/api-capabilities/openai-responses#与-chat-completions-api-对比 "与 Chat Completions API 对比的直接链接")
...
## 请求参数[​](/api-capabilities/openai-responses#请求参数 "请求参数的直接链接")
