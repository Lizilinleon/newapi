---
title: "Token (词元)"
description: "Token 概念详解，理解 ArmNet 字元服务 大模型API中转服务的计费基础"
lastUpdated: true
---
...
## 什么是 Token？[​](/wiki/basics/token#什么是-token "什么是 Token？的直接链接")
