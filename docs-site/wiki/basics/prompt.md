---
title: "提示词 (Prompt)"
description: "Prompt 提示词概念介绍，掌握通过 ArmNet 字元服务 大模型API中转服务高效使用AI的基础"
lastUpdated: true
---
...
## Prompt 的结构[​](/wiki/basics/prompt#prompt-的结构 "Prompt 的结构的直接链接")
...
## 提示词工程 (Prompt Engineering)[​](/wiki/basics/prompt#提示词工程-prompt-engineering "提示词工程 (Prompt Engineering)的直接链接")

提示词工程是一门通过优化 Prompt 来提升 AI 输出质量的技术。好的 Prompt 能让模型发挥出 120% 的能力，而糟糕的 Prompt 可能导致模型答非所问。

## 示例[​](/wiki/basics/prompt#示例 "示例的直接链接")
