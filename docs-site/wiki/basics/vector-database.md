...
description: "向量数据库概念介绍，配合 ArmNet 字元服务 大模型API中转服务构建检索增强应用"
lastUpdated: true
---
...
## 为什么需要向量数据库？[​](/wiki/basics/vector-database#为什么需要向量数据库 "为什么需要向量数据库？的直接链接")
...
## 常见向量数据库[​](/wiki/basics/vector-database#常见向量数据库 "常见向量数据库的直接链接")
...
## 工作流程[​](/wiki/basics/vector-database#工作流程 "工作流程的直接链接")
