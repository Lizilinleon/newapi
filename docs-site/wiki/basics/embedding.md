---
title: "嵌入 (Embedding)"
description: "Embedding 向量化技术介绍，ArmNet 字元服务 大模型API中转服务支持多种向量模型"
lastUpdated: true
---
...
## 核心概念[​](/wiki/basics/embedding#核心概念 "核心概念的直接链接")
...
## 语义相似度[​](/wiki/basics/embedding#语义相似度 "语义相似度的直接链接")
...
## 应用[​](/wiki/basics/embedding#应用 "应用的直接链接")
