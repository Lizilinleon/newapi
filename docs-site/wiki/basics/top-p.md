...
description: "Top-P 参数详解，在 ArmNet 字元服务 大模型API中转服务中控制输出多样性"
lastUpdated: true
---
...
## 工作原理[​](/wiki/basics/top-p#工作原理 "工作原理的直接链接")
...
## Top-p vs Temperature[​](/wiki/basics/top-p#top-p-vs-temperature "Top-p vs Temperature的直接链接")

- **Temperature** 是调整概率分布的“形状”（平滑或尖锐）。
- **Top-p** 是直接“截断”低概率的尾部。

## 最佳实践[​](/wiki/basics/top-p#最佳实践 "最佳实践的直接链接")
