---
title: "大语言模型 (LLM)"
description: "大语言模型（LLM）基础概念介绍，了解 ArmNet 字元服务 大模型API中转平台的核心技术"
lastUpdated: true
---
...
## 核心特征[​](/wiki/basics/llm#核心特征 "核心特征的直接链接")
...
## 常见用途[​](/wiki/basics/llm#常见用途 "常见用途的直接链接")
...
## 代表模型[​](/wiki/basics/llm#代表模型 "代表模型的直接链接")
