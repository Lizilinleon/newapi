---
title: "实时翻译"
description: "通过 ArmNet 字元服务 大模型API中转服务实现高质量的AI实时翻译"
lastUpdated: true
---
...
## LLM 翻译的优势[​](/wiki/applications/real-time-translation#llm-翻译的优势 "LLM 翻译的优势的直接链接")

### 对比传统翻译[​](/wiki/applications/real-time-translation#对比传统翻译 "对比传统翻译的直接链接")
...
### LLM 翻译能做到[​](/wiki/applications/real-time-translation#llm-翻译能做到 "LLM 翻译能做到的直接链接")
...
## 基础翻译实现[​](/wiki/applications/real-time-translation#基础翻译实现 "基础翻译实现的直接链接")

### 简单翻译[​](/wiki/applications/real-time-translation#简单翻译 "简单翻译的直接链接")
...
### 高质量翻译[​](/wiki/applications/real-time-translation#高质量翻译 "高质量翻译的直接链接")
...
## 高级功能[​](/wiki/applications/real-time-translation#高级功能 "高级功能的直接链接")

### 1. 流式翻译[​](/wiki/applications/real-time-translation#1-流式翻译 "1. 流式翻译的直接链接")
...
### 2. 批量翻译[​](/wiki/applications/real-time-translation#2-批量翻译 "2. 批量翻译的直接链接")
...
### 3. 文档翻译[​](/wiki/applications/real-time-translation#3-文档翻译 "3. 文档翻译的直接链接")
...
### 4. 双语对照[​](/wiki/applications/real-time-translation#4-双语对照 "4. 双语对照的直接链接")
...
## 特殊场景处理[​](/wiki/applications/real-time-translation#特殊场景处理 "特殊场景处理的直接链接")

### 1. 技术文档翻译[​](/wiki/applications/real-time-translation#1-技术文档翻译 "1. 技术文档翻译的直接链接")
...
### 2. 文学翻译[​](/wiki/applications/real-time-translation#2-文学翻译 "2. 文学翻译的直接链接")
...
### 3. 商务翻译[​](/wiki/applications/real-time-translation#3-商务翻译 "3. 商务翻译的直接链接")
...
## 质量评估[​](/wiki/applications/real-time-translation#质量评估 "质量评估的直接链接")

### 翻译评估提示词[​](/wiki/applications/real-time-translation#翻译评估提示词 "翻译评估提示词的直接链接")
...
## 最佳实践[​](/wiki/applications/real-time-translation#最佳实践 "最佳实践的直接链接")
