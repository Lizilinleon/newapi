---
title: "成本优化"
description: "使用 ArmNet 字元服务 大模型API中转服务时降低成本的实用策略"
lastUpdated: true
---
...
## 成本构成[​](/wiki/applications/cost-optimization#成本构成 "成本构成的直接链接")

### Token 计费模式[​](/wiki/applications/cost-optimization#token-计费模式 "Token 计费模式的直接链接")
...
### 价格示例[​](/wiki/applications/cost-optimization#价格示例 "价格示例的直接链接")

> 各模型的具体价格请参考官方定价页面或 [控制台](http://122.51.35.238:5170) 实时定价，以下仅为计费模式说明。

一般来说，输出 Token 价格高于输入 Token 价格，不同模型之间价格差异较大。选择模型时需综合考虑性能和成本。

## 模型选择优化[​](/wiki/applications/cost-optimization#模型选择优化 "模型选择优化的直接链接")

### 1. 任务分层[​](/wiki/applications/cost-optimization#1-任务分层 "1. 任务分层的直接链接")
...
### 2. 模型 A/B 测试[​](/wiki/applications/cost-optimization#2-模型-ab-测试 "2. 模型 A/B 测试的直接链接")
...
## Prompt 优化[​](/wiki/applications/cost-optimization#prompt-优化 "Prompt 优化的直接链接")

### 1. 精简输入[​](/wiki/applications/cost-optimization#1-精简输入 "1. 精简输入的直接链接")
...
### 2. 压缩上下文[​](/wiki/applications/cost-optimization#2-压缩上下文 "2. 压缩上下文的直接链接")
...
### 3. 优化系统提示词[​](/wiki/applications/cost-optimization#3-优化系统提示词 "3. 优化系统提示词的直接链接")
...
## 缓存策略[​](/wiki/applications/cost-optimization#缓存策略 "缓存策略的直接链接")

### 1. 结果缓存[​](/wiki/applications/cost-optimization#1-结果缓存 "1. 结果缓存的直接链接")
...
### 2. 语义缓存[​](/wiki/applications/cost-optimization#2-语义缓存 "2. 语义缓存的直接链接")
...
## 批处理优化[​](/wiki/applications/cost-optimization#批处理优化 "批处理优化的直接链接")

### 1. 合并请求[​](/wiki/applications/cost-optimization#1-合并请求 "1. 合并请求的直接链接")
...
### 2. 使用 Batch API[​](/wiki/applications/cost-optimization#2-使用-batch-api "2. 使用 Batch API的直接链接")
...
## 输出控制[​](/wiki/applications/cost-optimization#输出控制 "输出控制的直接链接")

### 1. 限制输出长度[​](/wiki/applications/cost-optimization#1-限制输出长度 "1. 限制输出长度的直接链接")
...
### 2. 结构化输出[​](/wiki/applications/cost-optimization#2-结构化输出 "2. 结构化输出的直接链接")
...
### 3. 提前终止[​](/wiki/applications/cost-optimization#3-提前终止 "3. 提前终止的直接链接")
...
## 成本监控[​](/wiki/applications/cost-optimization#成本监控 "成本监控的直接链接")

### 1. Token 追踪[​](/wiki/applications/cost-optimization#1-token-追踪 "1. Token 追踪的直接链接")
...
### 2. 预算控制[​](/wiki/applications/cost-optimization#2-预算控制 "2. 预算控制的直接链接")
...
## 成本优化清单[​](/wiki/applications/cost-optimization#成本优化清单 "成本优化清单的直接链接")
...
## 最佳实践[​](/wiki/applications/cost-optimization#最佳实践 "最佳实践的直接链接")
