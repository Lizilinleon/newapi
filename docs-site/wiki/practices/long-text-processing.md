---
title: "长文本处理"
description: "通过 ArmNet 字元服务 大模型API中转服务处理超长文本和大型文档的策略"
lastUpdated: true
---
...
## 挑战与限制[​](/wiki/practices/long-text-processing#挑战与限制 "挑战与限制的直接链接")

### 上下文窗口限制[​](/wiki/practices/long-text-processing#上下文窗口限制 "上下文窗口限制的直接链接")
...
### 长上下文的问题[​](/wiki/practices/long-text-processing#长上下文的问题 "长上下文的问题的直接链接")
...
## 处理策略[​](/wiki/practices/long-text-processing#处理策略 "处理策略的直接链接")

### 1. 分块处理（Chunking）[​](/wiki/practices/long-text-processing#1-分块处理chunking "1. 分块处理（Chunking）的直接链接")
...
### 2. 递归摘要（Map-Reduce）[​](/wiki/practices/long-text-processing#2-递归摘要map-reduce "2. 递归摘要（Map-Reduce）的直接链接")
...
### 3. 关键信息提取 + 压缩[​](/wiki/practices/long-text-processing#3-关键信息提取--压缩 "3. 关键信息提取 + 压缩的直接链接")
...
### 4. 滑动窗口[​](/wiki/practices/long-text-processing#4-滑动窗口 "4. 滑动窗口的直接链接")
...
## RAG 增强处理[​](/wiki/practices/long-text-processing#rag-增强处理 "RAG 增强处理的直接链接")

### 向量检索[​](/wiki/practices/long-text-processing#向量检索 "向量检索的直接链接")
...
## 特定任务的处理[​](/wiki/practices/long-text-processing#特定任务的处理 "特定任务的处理的直接链接")

### 1. 文档问答[​](/wiki/practices/long-text-processing#1-文档问答 "1. 文档问答的直接链接")
...
### 2. 文档摘要[​](/wiki/practices/long-text-processing#2-文档摘要 "2. 文档摘要的直接链接")
...
### 3. 文档翻译[​](/wiki/practices/long-text-processing#3-文档翻译 "3. 文档翻译的直接链接")
...
### 4. 代码库分析[​](/wiki/practices/long-text-processing#4-代码库分析 "4. 代码库分析的直接链接")
...
## 性能优化[​](/wiki/practices/long-text-processing#性能优化 "性能优化的直接链接")

### 1. 并行处理[​](/wiki/practices/long-text-processing#1-并行处理 "1. 并行处理的直接链接")
...
### 2. 缓存中间结果[​](/wiki/practices/long-text-processing#2-缓存中间结果 "2. 缓存中间结果的直接链接")
...
## 最佳实践[​](/wiki/practices/long-text-processing#最佳实践 "最佳实践的直接链接")
