---
{
  ...
  "source_url": "https://docs.weelinking.com/docs/scenarios/programming/gemini-cli",
  "description": "在 Gemini CLI 中接入 weelinking 大模型API中转服务，使用 Google AI 编程助手",
  "fetched_at": "2026-07-02T06:34:41.867709+00:00"
}
---

# Gemini CLI 接入指南

Gemini CLI 是谷歌推出的命令行 AI 助手，可以在终端中与 Gemini 模型对话、分析文件、理解图片和视频。通过 weelinking 接入后即可使用。

## 安装[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#安装 "安装的直接链接")
...
## 配置 weelinking[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#配置-weelinking "配置 weelinking的直接链接")
...
2. 在「用户变量」中点击「新建」，分别添加以下三个变量：
   - 变量名：`GOOGLE_GEMINI_BASE_URL`，变量值：`https://api.weelinking.com`
...
## 可用模型[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#可用模型 "可用模型的直接链接")
...
## 使用方法[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#使用方法 "使用方法的直接链接")

### 交互模式[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#交互模式 "交互模式的直接链接")
...
### 单次查询[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#单次查询 "单次查询的直接链接")
...
### 文件处理[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#文件处理 "文件处理的直接链接")
...
## 功能特色[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#功能特色 "功能特色的直接链接")
...
## 多模态使用[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#多模态使用 "多模态使用的直接链接")

Gemini 除了文字对话，还能理解图片和视频内容。

### 图像分析[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#图像分析 "图像分析的直接链接")
...
### 视频理解[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#视频理解 "视频理解的直接链接")
...
## 常见问题[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#常见问题 "常见问题的直接链接")

### 命令找不到[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#命令找不到 "命令找不到的直接链接")
...
### API 连接失败[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#api-连接失败 "API 连接失败的直接链接")

1. 打开上面创建的 `.gemini` 文件夹，检查 `.env` 文件中的地址和 API Key 是否填写正确
2. 确认 API Key 是否有效（可以在 weelinking 控制台查看）
3. 确认网络连接正常

### 模型不可用[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#模型不可用 "模型不可用的直接链接")

确保使用 Gemini 系列模型名称，参考上方「可用模型」表格。

### Node.js 版本问题[​](https://docs.weelinking.com/docs/scenarios/programming/gemini-cli#nodejs-版本问题 "Node.js 版本问题的直接链接")
