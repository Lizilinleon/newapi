---
{
  ...
  "source_url": "https://docs.weelinking.com/docs/scenarios/programming/codex-cli",
  "description": "在 Codex CLI 中接入 weelinking 大模型API中转服务，OpenAI 编程工具配置指南",
  "fetched_at": "2026-07-02T06:34:42.673145+00:00"
}
---
...
## 安装[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#安装 "安装的直接链接")
...
## 配置 weelinking[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#配置-weelinking "配置 weelinking的直接链接")
...
## 使用方法[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#使用方法 "使用方法的直接链接")

### 交互模式[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#交互模式 "交互模式的直接链接")
...
### 直接执行[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#直接执行 "直接执行的直接链接")
...
### 让 Codex 读取文件内容[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#让-codex-读取文件内容 "让 Codex 读取文件内容的直接链接")
...
## 功能特色[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#功能特色 "功能特色的直接链接")
...
## 推荐模型[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#推荐模型 "推荐模型的直接链接")
...
## 常见问题[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#常见问题 "常见问题的直接链接")

### 命令找不到[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#命令找不到 "命令找不到的直接链接")
...
### API 连接失败[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#api-连接失败 "API 连接失败的直接链接")

1. 打开上面创建的 `.codex` 文件夹，检查 `config.toml` 中的地址是否填写正确
2. 检查 `auth.json` 中的 API Key 是否有效
3. 确认网络连接正常

### Node.js 版本问题[​](https://docs.weelinking.com/docs/scenarios/programming/codex-cli#nodejs-版本问题 "Node.js 版本问题的直接链接")
