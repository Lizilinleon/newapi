---
{
  ...
  "source_url": "https://docs.weelinking.com/docs/scenarios/programming/claude-code",
  "description": "在 Claude Code 中接入 weelinking 大模型API中转服务，使用终端AI编程助手",
  "fetched_at": "2026-07-02T06:34:37.310852+00:00"
}
---
...
## 安装[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#安装 "安装的直接链接")
...
## 配置 weelinking[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#配置-weelinking "配置 weelinking的直接链接")
...
2. 在「用户变量」中点击「新建」，分别添加以下两个变量：
   - 变量名：`ANTHROPIC_BASE_URL`，变量值：`https://api.weelinking.com`
...
```
$env:ANTHROPIC_BASE_URL="https://api.weelinking.com"; $env:ANTHROPIC_AUTH_TOKEN="YOUR_API_KEY"; claude
```
...
```
# Zsh（macOS 默认）  
echo 'export ANTHROPIC_BASE_URL=https://api.weelinking.com' >> ~/.zshrc  
...
```
ANTHROPIC_BASE_URL=https://api.weelinking.com ANTHROPIC_AUTH_TOKEN=YOUR_API_KEY claude
```
...
```
echo 'export ANTHROPIC_BASE_URL=https://api.weelinking.com' >> ~/.bashrc  
...
## 推荐模型[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#推荐模型 "推荐模型的直接链接")
...
## 使用示例[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#使用示例 "使用示例的直接链接")

### 启动交互模式[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#启动交互模式 "启动交互模式的直接链接")
...
### 直接执行任务[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#直接执行任务 "直接执行任务的直接链接")
...
### 在项目中使用[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#在项目中使用 "在项目中使用的直接链接")
...
## 功能特色[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#功能特色 "功能特色的直接链接")
...
## 常见问题[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#常见问题 "常见问题的直接链接")

### 命令找不到[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#命令找不到 "命令找不到的直接链接")
...
### API 连接失败[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#api-连接失败 "API 连接失败的直接链接")

1. 确认 API 地址正确（不需要 `/v1` 后缀）
2. 检查 API Key 是否有效
3. 验证网络连接

### 模型不可用[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#模型不可用 "模型不可用的直接链接")

确保使用 Claude 系列模型名称，参考上方「推荐模型」表格。

### Node.js 版本问题[​](https://docs.weelinking.com/docs/scenarios/programming/claude-code#nodejs-版本问题 "Node.js 版本问题的直接链接")
