...
{
  "title": "监控与日志",
  "source_url": "https://docs.weelinking.com/docs/wiki/practices/monitoring-logging",
  "description": "使用 weelinking 大模型API中转服务时的监控与日志最佳实践",
  "fetched_at": "2026-07-02T06:35:20.820628+00:00"
}
---
...
## 监控指标[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#监控指标 "监控指标的直接链接")

### 核心指标[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#核心指标 "核心指标的直接链接")
...
### 指标收集[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#指标收集 "指标收集的直接链接")
...
### 使用 Prometheus[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#使用-prometheus "使用 Prometheus的直接链接")
...
## 日志记录[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#日志记录 "日志记录的直接链接")

### 结构化日志[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#结构化日志 "结构化日志的直接链接")
...
### 日志级别[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#日志级别 "日志级别的直接链接")
...
## 告警配置[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#告警配置 "告警配置的直接链接")

### 告警规则[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#告警规则 "告警规则的直接链接")
...
### 告警通知[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#告警通知 "告警通知的直接链接")
...
## 追踪（Tracing）[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#追踪tracing "追踪（Tracing）的直接链接")

### 请求追踪[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#请求追踪 "请求追踪的直接链接")
...
## Dashboard[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#dashboard "Dashboard的直接链接")

### Grafana 配置示例[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#grafana-配置示例 "Grafana 配置示例的直接链接")
...
## 最佳实践[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#最佳实践 "最佳实践的直接链接")

### 监控[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#监控 "监控的直接链接")
...
### 日志[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#日志 "日志的直接链接")
...
### 告警[​](https://docs.weelinking.com/docs/wiki/practices/monitoring-logging#告警 "告警的直接链接")
